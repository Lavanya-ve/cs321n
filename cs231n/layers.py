...
def batchnorm_forward(x, gamma, beta, bn_param):
    ...
    if mode == "train":
        ...
        batch_std = np.std(batch_var+eps)
        # batch_std = int(math.sqrt(batch_var+eps))

        # print(f"Shape of batch_mean is: {batch_mean.shape}")
        # print(f"Shape of batch_std is: {batch_std.shape}")
